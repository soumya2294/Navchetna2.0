...
import { FiActivity, FiZap, FiTarget, FiTrendingUp, FiClock, FiArrowRight, FiAward } from 'react-icons/fi'
import { useNavigate } from 'react-router-dom'

function Dashboard() {
  const navigate = useNavigate()
  const stats = [
    { icon: <FiActivity />, value: '8,542', label: 'Steps Today' },
    { icon: <FiZap />, value: '620', label: 'Calories Burned' },
    { icon: <FiClock />, value: '48 min', label: 'Active Time' },
    { icon: <FiTrendingUp />, value: '12', label: 'Day Streak' }
  ]
  ...
  return (
    <div className="training-page">
      <div className="training-page-header">
        ...
        <button className="add-workout-btn" onClick={() => navigate('/workouts')}>
          Start Workout <FiArrowRight />
        </button>
      </div>
      ...
      <div className="dashboard-section">
        <div className="dashboard-performance-grid">
          {stats.map((stat, index) => (
            <div className="dashboard-perf-card" key={index}>
              {stat.icon}
              <h2>{stat.value}</h2>
        ...
        <div className="dashboard-main-grid">
          <div className="dashboard-card daily-goal-card">
            ...
            <div className="goal-details">
              <div><strong>8,542</strong><span>Steps</span></div>
              <div><strong>10,000</strong><span>Goal</span></div>
            </div>
          </div>
      ...
      <div className="dashboard-section" style={{ marginTop: '30px' }}>
        ...
        <div className="workout-summary-grid">
          <button className="workout-summary-card" onClick={() => navigate('/workouts')}>
            <FiActivity />
            <div>
              <h2>My Workouts</h2>
          ...
          <button className="workout-summary-card" onClick={() => navigate('/leaderboard')}>
            <FiAward />
            <div>
              <h2>Leaderboard</h2>
